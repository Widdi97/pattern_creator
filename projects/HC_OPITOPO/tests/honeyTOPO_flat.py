...
sizeyum = 155
file_name = f"HC_OPITOPO_d{diameter}_SB.pat"
...
with open(file_name, 'w') as file:
    ...
    for (overlapp1, overlapp2) in zip(overlapp1_list, overlapp2_list):
        ...
        pn1 = f"honeytopo_d{diameter}_va{overlapp1}_vb{overlapp2}_1,{shiftx},{shifty},{repx},{ny}"
        pattern_name1 = pn1.replace(".","p")
        print(pn1)
        pn2 = f"honeytopo_d{diameter}_va{overlapp1}_vb{overlapp2}_2,{shiftx},{shifty},{repx},{ny}"
        pattern_name2 = pn2.replace(".","p")
        print(pn2)
        pn3 = f"honeytopo_d{diameter}_va{overlapp1}_vb{overlapp2}_3,{shiftx},{shifty},{repx},1"
        pattern_name3 = pn3.replace(".","p")
        print(pn3)
        pn4 = f"honeytopo_d{diameter}_va{overlapp1}_vb{overlapp2}_4,{shiftx},{shifty},{repx},1"
        pattern_name4 = pn4.replace(".","p")
        print(pn4)
        pn5 = f"honeytopo_d{diameter}_va{overlapp1}_vb{overlapp2}_5,{shiftx},{shifty},1,{ny}"
