...
x_size_ = 10 * a
y_size_ = 8 * a
lattice = Lattice(a1_ * vc_e, a2_* vc_e, x_size_, y_size_, 0.08 * a, [[circle, 0, 0, a/(3*2)] for b in bs], bs)

#%%
field = np.arraysiz([x_size_, y_size_])


# -*- coding: utf-8 -*-
"""
Created on Fri Sep 13 11:24:53 2024
