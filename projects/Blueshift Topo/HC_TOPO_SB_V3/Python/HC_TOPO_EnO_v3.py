...
fields=1 # 1: left or 2: right
overlap1_list1 = [1.20, 1.00, 1.20, 1.10, 1.20, 1.10, 1.20, 1.10]
overlap2_list1 = [1.20, 1.00, 1.00, 0.95, 0.95, 0.90, 0.90, 0.85]
overlap1_list2 = [0.90, 0.80, 1.00, 0.90, 1.00, 0.90, 1.00, 0.90]
overlap2_list2 = [0.90, 0.80, 0.90, 0.85, 0.85, 0.80, 0.80, 0.75]
if fields == 1:
    overlap1_list = overlap1_list1
    overlap2_list = overlap2_list1
elif fields == 2:
    overlap1_list = overlap1_list2
    overlap2_list = overlap2_list2
resolution = [25,1]
...
if __name__ == "__main__":
    ...
    for diameter in diameters:
        ...
        file_name = f"HC_TOPO_EnO_d{diameter}_res_{resolution[0]}_{spalten}x{zeilen}_{fields}_SB.pat"
