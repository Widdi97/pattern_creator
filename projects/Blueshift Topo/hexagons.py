...
diameter_list = [1.7, 2.0, 2.5]
overlapp_list = [0.7,0.75, 0.80, 0.85, 0.90, 0.95, 1.00, 1.05, 1.10, 1.15, 1.20,1.25,1.3]
resolution_ratio = 15
#resolution = 100
start_x = 220000
start_y = 0
...
for x in range(2):
    if x == 0:
        ...
        flat_top = False
    if flat_top:
        file_name = f"hexagons_res{resolution_ratio}_flat.pat"
    else:
    ...
    with open(file_name, 'w') as file:
        for diameter in diameter_list:
            ...
            if flat_top:
                file.write("D hexagon_flat_"+ dia_string + '\n' + "I 1" + '\n' + "C 100" + '\n')
            else:
               file.write("D hexagon_peak_"+ dia_string + '\n' + "I 1" + '\n' + "C 100" + '\n')
            ...
            for overlapp in overlapp_list:
                ...
                for i in range(6):
                    ...
                    pattern_string = pattern.export_pattern(complete=False, export=False, offsetx=start_x + x_abstand*position-(1000*width/2), offsety= start_y + diameter_list.index(diameter)*y_abstand) 
